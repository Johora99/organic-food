...
export default async function Blog() {
  const blogsData = async ()=>{
    const res = await axios.get('https://organic-food-tbmk.vercel.app/blog.json')
  ...
  return (
    <div className='w-full relative py-20'>
      ...
      <div className='text-center'>
        <p className='text-base text-pureGreen font-normal uppercase' style={{fontFamily: "MyFont"}}>Blog</p>
        <h3 className='text-4xl text-darkGray font-semibold mb-10'>Latest News</h3>
      </div>
